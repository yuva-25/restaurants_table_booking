...
$sql = "SELECT * FROM tablebooking WHERE cus_status='' ";
$booking_list = mysqli_query($conn, $sql);
...
<body>
    <div class="container-fluid da">
        <div class="row">
            ...
            <div class="col-lg-9">
                <h3 class="text-center py-4">Booking List</h3>
                                ...
                                if(!empty($booking_list)) {
                                    foreach($booking_list as $data) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href ="booking_update.php?update_id=<?php echo $data['id']; ?>"class = "btn btn-danger">UPDATE</a>
                                            </td>
                                        </tr>
                                <?php  }
                                }
